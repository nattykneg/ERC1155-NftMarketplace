...
Route::get('nft/explore', 'NftController@getNftExplore')->name('nft-explore');
Route::get('nft/explore/{nftId}', 'NftController@getNftDetail')->name('nft-item');
Route::get('nft/list/{walletId}', 'NftController@getWalletDetail')->name('nft-wallet');
Route::post('nft/wishlist', 'NftWishlistController@create')->name('nft-wishlist');
Route::post('nft/view', 'NftViewController@create')->name('nft-view');
...
Route::group(['middleware' => 'user'], function () {
    ...
    Route::get('/select-nft', 'UserController@selectNFT');
    Route::get('profile', 'UserController@getProfile');
    Route::get('nft', 'UserController@getNFT');
...
Route::post('paypal-create', 'DepositController@CreatePaypal');
Route::get('paypal-status/{amount}', 'DepositController@PaypalStatus');
Route::get('paypal-cancel', 'DepositController@PaypalCancel');
...
Route::group(['middleware' => 'admin'], function () {
    ...
    //NFT Mint
    Route::resource('admin-nft', 'AdminNftController');
    Route::post('store-nft', ['as' => 'admin-nft.store', 'uses' => 'AdminNftController@store']);
    Route::post('store-nftprice', ['as' => 'admin-nftprice.store', 'uses' => 'AdminNftController@storeNftPrice']);
    Route::post('update-nftprice', ['as' => 'admin-nftprice.update', 'uses' => 'AdminNftController@updateNftPrice']);

    //NFT IGO
    Route::resource('admin-nftigo', 'AdminNftIgoController');
    Route::post('store-nftigo', ['as' => 'admin-nftigo.store', 'uses' => 'AdminNftIgoController@store']);
    Route::post('upload-nftigo', 'AdminNftIgoController@uploadNftImage');
