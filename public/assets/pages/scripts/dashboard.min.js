if(business_time===undefined){var business_time="";var business_to_time="";var business_break_start="";var business_break_end="";var business="[0,1,2,3,4,5,6]"}
var Dashboard=function(){return{initJQVMAP:function(){if(jQuery().vectorMap){var e=function(e){jQuery(".vmaps").hide(),jQuery("#vmap_"+e).show()},t=function(e){var t=jQuery("#vmap_"+e);if(1===t.size()){var a={map:"world_en",backgroundColor:null,borderColor:"#333333",borderOpacity:.5,borderWidth:1,color:"#c6c6c6",enableZoom:!0,hoverColor:"#c9dfaf",hoverOpacity:null,values:sample_data,normalizeFunction:"linear",scaleColors:["#b6da93","#909cae"],selectedColor:"#c9dfaf",selectedRegion:null,showTooltip:!0,onLabelShow:function(e,t,a){},onRegionOver:function(e,t){"ca"==t&&e.preventDefault()},onRegionClick:function(e,t,a){var i='You clicked "'+a+'" which has the code: '+t.toUpperCase();alert(i)}};a.map=e+"_en",t.width(t.parent().parent().width()),t.show(),t.vectorMap(a),t.hide()}};t("world"),t("usa"),t("europe"),t("russia"),t("germany"),e("world"),jQuery("#regional_stat_world").click(function(){e("world")}),jQuery("#regional_stat_usa").click(function(){e("usa")}),jQuery("#regional_stat_europe").click(function(){e("europe")}),jQuery("#regional_stat_russia").click(function(){e("russia")}),jQuery("#regional_stat_germany").click(function(){e("germany")}),$("#region_statistics_loading").hide(),$("#region_statistics_content").show(),App.addResizeHandler(function(){jQuery(".vmaps").each(function(){var e=jQuery(this);e.width(e.parent().width())})})}},initCalendar:function(){if(jQuery().fullCalendar){var e=new Date,t=e.getDate(),a=e.getMonth(),i=e.getFullYear(),l={};$("#calendar").width()<=400?($("#calendar").addClass("mobile"),l={left:"title, prev, next",center:"",right:"month,agendaWeek,agendaDay"}):($("#calendar").removeClass("mobile"),l=App.isRTL()?{right:"title",center:"",left:"prev,next,month,agendaWeek,agendaDay"}:{left:"title",center:"",right:"prev,next,month,agendaWeek,agendaDay"}),$("#calendar").fullCalendar("destroy"),$("#calendar").fullCalendar({disableDragging:!0,header:l,editable:!1,events:[],businessHours:[{className:'fc-nonbusiness',start:business_time,end:business_break_start,dow:business,rendering:'inverse-background'},{className:'fc-nonbusiness',start:business_break_end,end:business_to_time,dow:business,rendering:'inverse-background'}],displayEventEnd:{month:!0,basicWeek:!0,"default":!0},eventRender:function(event,element){element.attr('href','javascript:void(0);');if(event.customer){element.find("div.fc-content").prepend('<b>'+event.customer+'</b>')}
element.click(function(){if(event.description)
$('#event_title').html('Appointment Details');else $('#event_title').html('User Activity');var start=moment(event.start).format('Do-MMM-YYYY HH:mm:ss');var end=moment(event.end).format('Do-MMM-YYYY HH:mm:ss');var event_data='';if(event.title)
var event_data='<tr><th>Title</th><td>'+event.title+'</td></tr>';if(event.description){if(event.customer)
event_data+="<tr><th>Customer</th><td>"+event.customer+"</td></tr>";event_data+='<tr><th>Description</th><td>'+event.description+'</td></tr>'}
event_data+='<tr><th>Start</th><td>'+start+'</td></tr>';if(event.end)
event_data+='<tr><th>End</th><td>'+end+'</td></tr>';if(event.cus_status){event_data+='<tr><th>Current Status</th><td><select class="form-control" onchange="change_cur_status('+event.sch_id+',this.value)">\
