  ...
  <div class="page-sidebar navbar-collapse collapse">
    ...
    <ul class="page-sidebar-menu   " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
	  ...
	  <li class="nav-item  ">
        <a href="{{ url('admin-sponser') }}" class="nav-link ">
          <i class="fa fa-exchange"></i>
          <span class="title">Sponsor Links</span>
        </a>
      </li>
    </ul>
    ...
    <ul class="page-sidebar-menu   " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
     ...
     <li class="heading">
            ...
            <li class="nav-item {{{ (Request::is('admin-nft') ? 'active' : '') }}}">
                <a href="{{url('admin-nft')}}" class="nav-link ">
                    <i class="fa fa-calendar"></i>
                    <span class="title">NFT Mint</span>
                </a>
            </li>
            <li class="nav-item {{{ (Request::is('admin-nftigo') ? 'active' : '') }}}">
                <a href="{{url('admin-nftigo')}}" class="nav-link ">
                    <i class="fa fa-calendar"></i>
                    <span class="title">NFT IGO</span>
                </a>
            </li>
    ...
    <ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
      ...
      <li class="nav-item start {{{ (Request::is('profile') ? 'active' : '') }}} ">
        ...
        <!--<li class="nav-item  {{{ (Request::is('nft') ? 'active' : '') }}}">-->
        <!--    <a href="{{ url('nft') }}" class="nav-link ">-->
        <!--        <i class="fa fa-gift"></i>-->
        <!--        <span class="title">My NFT</span>-->
        <!--    </a>-->
        <!--</li>-->
