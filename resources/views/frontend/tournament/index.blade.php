...
@section('title') {{$tournament->name}} - BitSport &trade; | Peer to Peer competitive eSports Platform @endsection
@section('head')
...
<!--
                ...
                <div class="btn-card">
          <a id="sponsor_tournament" class="btn-join" href="<?php if(!empty($sponsers)){ echo $sponsers[0]->link;}?>">Sponsor Tournament (Earn)</a>  
                </div>
							 </tbody>					
						 </table>
					 </div>
