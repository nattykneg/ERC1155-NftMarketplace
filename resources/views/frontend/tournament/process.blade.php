                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <div class="checkbox cust-check">
                              ...
                              <label for="styled-checkbox-1">I Agree to tournament rules</label>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <select class="selectpicker" name="platform" id="platform">
                          <option value="Play Station">Play Station 5</option>
                          <option value="Xbox">Playstation 4</option>
                        </select>
                      </div>
                    </div>
                   </div>
