...
@section('title') BitSport Tournaments &trade; | Peer to Peer competitive eSports platform @endsection
@section('head')
...
<div class="content col-md-9">
  ...
  <div class="col-md-12">
      ...
      <ul class="nav custom-tab nav-tabs">
          <li class="active"><a data-toggle="tab" href="#payPaypal"><span> <img  width="50" height="40"  src="{{url('/')}}/assets/images/coins/paypal.png"></span> Pay by Paypal</a></li>
      ...
      <div class="tab-content">
        ...
        <div id="paybtp" class="tab-pane fade">
          ...
          <p>You can add more BTP coins by using the <a target="_blank" href="{{url('wallet')}}">wallet</a> page and discover various options of acquiring BTP tokens.</p>
