...
@section('title') Challenge {{$challenge->creator->username}} on a Game of {{$challenge->game->name}} for {{$challenge->amount.' '.config('app.currency') }} | BitSport Challenges @endsection
@section('description') Got what it takes to  challenge {{$challenge->creator->username}} on a Game of {{$challenge->game->name}} for {{$challenge->amount.' '.config('app.currency') }} Lets see who is Boss! @endsection
@section('head')
...
<div class="content col-md-9">
	...
	<div class="card card--clean mb-0 mainsectionbg">
		<div class="challenge-detail-header">
			...
			@if (!empty(Sentinel::getUser()) && $challenge->creator->id == Sentinel::getUser()->id)
					...
					<div class="modal-body mainsectionbg">
						<div class="row">
							...
							<div class="col-sm-6">
								...
								<div class="row">
									<div class="col-md-12">
										Amount: {{$challenge->amount.' '.config('app.currency') }} <img src="{{url('/')}}/assets/images/coins/btpcoin.png" style="width:20px;"/>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#accept-confirm-detail').click(function() {
			@if(empty(Sentinel::getUser()))
				window.alert("You should logged in first");
