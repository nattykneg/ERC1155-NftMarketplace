...
<head>
    <meta charset="utf-8">
    <title>BitSport Tournament: You have been Matched</title>
</head>
<body>
...
<table class="table_full editable-bg-color bg_color_e6e6e6 editable-bg-image" bgcolor="#e6e6e6" width="100%" align="center"  mc:repeatable="castellab" mc:variant="Header" cellspacing="0" cellpadding="0" border="0">
	...
	Thank you for choosing to participate in the {{ $tournament->name }}, further sections of this email contains your match details, general guidelines and rules. <br><br>
<p><strong>We require you to join the BitSport Discord Channel for information and help prior to your Play time. <a href="https://discord.gg/BFfQHmp">Click here to join Discord channel</a></strong></p>
...
<p>Match Type: Online Friendlies</p>
...
<p>In the event of any question, feel free to reach us on the Discord channel.</p>
...
<p>Login to your account from <a href="https://bitsport.gg">here</a></p>
										...
										<tr>
											<td mc:edit="text004" align="center" valign="middle" style="color: #ffffff; font-size: 16px; font-weight: 600; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;" class="text_color_ffffff">
												<div class="editable-text">
													<span class="text_container">
														<multiline>
															<a href="https://dapp.bitsport.gg/event-odds/{{$event->id}}" style="text-decoration: none; color: #ffffff;">Check-In</a>
														</multiline>
													</span>
												</div>
											</td>
